...
export default function ToolPage() {
  ...
  return (
    <div className="pt-32 mt-10 px-10 lg:px-40 mb-20">
      <div className="flex justify-start items-center">
        ...
        <div className="flex flex-col justify-start items-start ml-10">
          ...
          <p className="mb-4 text-left">{tool.description}</p>
          ...
          <button
            ...
            className="rounded-3xl w-48 h-12 px-2 py-1 text-white bg-gray-700 hover:bg-gray-600 transition-all duration-200 ease-in-out mt-5 cursor-pointer"
          >
            Go to Site
          </button>
